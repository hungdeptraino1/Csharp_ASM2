    ...
    public partial class WaterBill : Form
    {
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            if (lstVBill.SelectedItems.Count > 0)
            {
                ...
                if (dl == DialogResult.Yes)
                {
                    lstVBill.Items.Remove(lstVBill.SelectedItems[0]);
                    txtFullName.Clear();
                    cobCustomerType.Items.Clear();
                    txtMember.Clear();
                    txtLastMonthWater.Clear();
        ...
        private void btnCal_Click(object sender, EventArgs e)
        {
            ...
            if (type == "Household customer")
            {
                ...
                {
                    MessageBox.Show("Please enter your customer type", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                else if (string.IsNullOrEmpty(Nummember))
                {
                    MessageBox.Show("Please enter your family membere", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                else if (!int.TryParse(Nummember, out _))
                {
                    MessageBox.Show("Number of members must be interger", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                ...
                else if (int.Parse(lastmonthwaterindex) < 1)
                {
                    MessageBox.Show("Last month water index must be >= 1", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                ...
                else if (int.Parse(thismonthwaterindex) < 1)
                {
                    MessageBox.Show("This month water index must be >= 1", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
